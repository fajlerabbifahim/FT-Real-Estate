...
import register from "../../assets/Login-Images/register.jpg";
const Register = () => {
  return (
      ...
      <div className="bg-white w-full max-w-4xl mx-4 md:mx-auto rounded-lg shadow-lg overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col justify-center items-center bg-[#F4F4F4] p-6">
            ...
            <img src={register} alt="Signup Illustration" className="mt-4" />
          </div>

          {/* Right Section */}
          <div className="p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-[#00509E]">Register</h2>
            </div>
            ...
            <form className="space-y-4">
              ...
              <div className="flex items-center border rounded-lg px-3 py-2">
                ...
                <select className="flex-1 outline-none border-none pl-3 bg-transparent">
